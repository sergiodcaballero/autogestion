...
<form id="form1" name="form1" method="post" action="">
 ...
 require_once('connections/honorarios.php'); 
  ...
  <table width="647" border="1" style="font-size:12px;">
    ...
    <tr>
      <td width="96"><div align="center">N&ordm; Afiliado</div></td>
      <td width="96"><div align="center">Nombre</div></td>
      <td width="96"><div align="center">Plan</div></td>
      <td width="96"><div align="center">N&ordm; Doc</div></td>
      <td width="96"><div align="center">Parentesco</div></td>
      <td width="141"><div align="center">Fecha de Nacimiento</div></td>
 ...
 // echo $_SESSION['n_benef']; 
  $consulta = "SELECT N_Afiliado, Nombre, NUM_DOC, Plan_ , Parentesco, date_format(F_NAC,'%d-%m-%Y') as fecha,n_benef FROM ppadron where N_afiliado =".$N_Afiliado." and  Num_Doc =".$Nro_Doc;//beneficiario
