    ...
    <td height="176" align="center"><div align="center">
      ...
      <table border='1'>
          <caption style='font-size:16pt'>
            Primer Ingreso al Sistema <br>
            Verifique sus 
          Datos de Afiliado <br>
          </caption>
          <tr>
...
?>
      ...
      <form name="form1" method="post" action="validar_password_new">
        <p>
          <label for="Nueva_Contrasena"> Nueva Contrase&ntilde;a : </label>
          <input name="pass_new" type="password" maxlength="10">
        </p>
        <p>
          <label for="Repetir_Contrasena">Repetir Contrase&ntilde;a:</label>
